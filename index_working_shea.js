...
Lotion.connect = function(GCI, opts = {}) {
  return new Promise(async (resolve, reject) => {
    ...
    console.log("nodes length was " + nodes.length + " and fullNodeRpcAddress is " + fullNodeRpcAddress)
    ...
    let methods = {
      ...
      getState: async function(path = '') {
        ...
        console.log(appHashByHeight)
        console.log("appHashByHeight is " + appHashByHeight)
        console.log('respheight is ' + resp.height)
